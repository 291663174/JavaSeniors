package com.wuhen.java2;

import com.wuhen.java1.Person;
...
public class ReflectionTest {
    ...
    public void testField() throws Exception{
        ...
        /**
         *  设置当前属性的值
         *      set()：参数1：指明设置哪个对象的属性  参数二：将此属性值设置为多少
         **/
        id.set(person, 1001);
    ...
    public void testMethod() throws Exception{
        ...
        /**
         *  3.调用invoke():参数一：方法的调用者  参数2：给方法形参赋值的实参
